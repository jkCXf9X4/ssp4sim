...
{
    GraphBuilder::GraphBuilder(const analysis::SspSystem &analysis_system_,
    ...
    // this is the analysis graph builder responsibility to build the analysis model-model graph, this should only utilize it for creating the final 
    ...
    // move this to the simulation graph
