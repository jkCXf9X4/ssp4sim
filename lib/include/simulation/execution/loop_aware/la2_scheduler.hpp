...
namespace ssp4sim::graph
{
    ...
    public:
        ...
        // SCCs computed from the graph (copied after analyze(); the analysis
        // lives on `graph` which is a value member, so value members keep the
        // scheduler movable without dangling references).
