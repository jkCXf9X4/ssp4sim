...
namespace ssp4sim::graph
{
    ...
    RealtimeMacroExecutor::RealtimeMacroExecutor(std::vector<std::unique_ptr<Invocable>> nodes) : ExecutionBase(std::move(nodes), "ssp4sim.graph.RealtimeMacroExecutor")
    {
