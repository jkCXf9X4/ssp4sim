...
The recorder currently ships with a low-rate CSV sink, a full-fidelity Parquet
sink, and a direct DuckDB sink. Additional sinks can be added when another
export path needs the same event stream.
