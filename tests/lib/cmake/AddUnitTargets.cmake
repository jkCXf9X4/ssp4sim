...
set(SSP4SIM_TEST_INCLUDE_DIRS
  ...
  "${CMAKE_SOURCE_DIR}/lib/include/pre/2_analysis_graph"
  "${CMAKE_SOURCE_DIR}/lib/include/pre/2_analysis_graph/elements"
    ...
    foreach(_file IN LISTS _frontier)
      ...
      foreach(_spec IN LISTS _incs)
        ...
        if(NOT _hit)
          if(_unresolved_out)
            set(_local FALSE)
            if(_spec MATCHES "^(pre|utils|simulation|scheduling|1_ssp_parser|2_analysis_graph|3_simulation_graph|graph_executor)/")
              set(_local TRUE)
            endif()
