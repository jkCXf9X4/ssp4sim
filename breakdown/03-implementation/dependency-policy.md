...
- **Why vcpkg**: The remaining dependencies (nlohmann_json, TBB, quill) are well-established, versioned on vcpkg, and benefit from centralized version management.
...
- Result CSVs and SQLite databases
- Log files
- FMU/SSP binaries
