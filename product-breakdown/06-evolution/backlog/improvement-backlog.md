...
| `candidates/IMP-040.md` | IMP-040 | Integration test: external SSV/SSM loading | Proposed | Medium | Low-Medium — test files only; no production code changes |
...
| IMP-040 | Integration test: external SSV/SSM loading | Medium | None | Low-Medium — test files only; no production code changes |
